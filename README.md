...
```kotlin
dependencies {
  implementation("com.stripe:stripeterminal:5.1.0")
}
```
...
```kotlin
dependencies {
  implementation("com.stripe:stripeterminal-taptopay:5.1.0")
  implementation("com.stripe:stripeterminal-core:5.1.0")
}
```
...
## Documentation
 ...
 - [5.x API Reference](https://stripe.dev/stripe-terminal-android)
 - [4.x API Reference](https://stripe.dev/stripe-terminal-android/v4)
