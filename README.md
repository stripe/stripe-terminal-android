...
To use the Android SDK, add the SDK to the `dependencies` block of your `build.gradle` file:
    ...
    dependencies {
        implementation "com.stripe:stripeterminal:2.21.0"
    }
...
```groovy
dependencies {
  implementation "com.stripe:stripeterminal-localmobile:2.21.0"
  implementation "com.stripe:stripeterminal-core:2.21.0"
}
```
