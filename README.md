...
```groovy
dependencies {
  implementation "com.stripe:stripeterminal:3.8.1"
}
```
...
```groovy
dependencies {
  implementation "com.stripe:stripeterminal-localmobile:3.8.1"
  implementation "com.stripe:stripeterminal-core:3.8.1"
}
```
