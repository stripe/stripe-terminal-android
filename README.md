...
```kotlin
dependencies {
  implementation("com.stripe:stripeterminal:4.7.2")
}
```
...
```kotlin
dependencies {
  implementation("com.stripe:stripeterminal-taptopay:4.7.2")
  implementation("com.stripe:stripeterminal-core:4.7.2")
}
```
